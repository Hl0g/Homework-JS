...
let key = prompt("Write , please, a key:");
let value = prompt("Write, please, value:");
function newProperty(key, value, object){
if (object[key] === undefined){
  object[key] = value;
} else{
  console.error("Already using  , sorry please")
}
}
...
const numberTen = prompt("Please, write, a number");
let factorial = 1;
